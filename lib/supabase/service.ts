 ...
 * tête de son fichier :**
 *
 * - `lib/auth/installation.ts` : crée le tout premier compte, celui du
 *   propriétaire. Appelé par un inconnu, il se méfie de son appelant : il
 *   réserve la ligne d'installation avant de créer quoi que ce soit, et la
